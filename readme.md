...
## Codebase
### Chart of Sha-Spec Fusion Architecture
```mermaid
flowchart TD
...
subgraph MODEL["3 · Model"]
  ...
  shaspec["<b>ShaSpec robustness</b> <i>(opt-in)</i><br/>adds modality-specific encoders<br/>one modality dropped at random<br/>during training"]
...
subgraph SIDE["Supporting tools"]
  ...
  missing["Missing-modality handling<br/>detect which modalities a case has,<br/>or split a folder into per-modality subsets"]
  tests["Tests <i>(CPU only)</i><br/>CT-passthrough · training stability<br/>embedding capture · modality detection"]
end
...
shaspec -.->|"wraps the encoder when enabled"| fusion
...
click entry "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/tree/shaspec-fusion/scripts"
click study "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/blob/shaspec-fusion/readme.md"
click ckpt "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/blob/shaspec-fusion/readme.md"
click io "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/blob/shaspec-fusion/lesionlocator/imageio/simpleitk_reader_writer.py"
click prep "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/tree/shaspec-fusion/lesionlocator/preprocessing"
click prompt "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/tree/shaspec-fusion/lesionlocator/utilities/prompt_handling"
click net "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/blob/shaspec-fusion/lesionlocator/utilities/get_network_from_plans.py"
click tracknet "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/blob/shaspec-fusion/lesionlocator/modules/tracknet.py"
click train "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/blob/shaspec-fusion/lesionlocator/training/train_segment.py"
click infer "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/blob/shaspec-fusion/lesionlocator/inference/lesionlocator_segment_and_track.py"
click masks "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/blob/shaspec-fusion/lesionlocator/inference/export_prediction.py"
click metrics "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/blob/shaspec-fusion/lesionlocator/utilities/surface_distance_based_measures.py"
click npz "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/blob/shaspec-fusion/lesionlocator/inference/lesionlocator_segment_and_track_embed.py"
click fusion "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/blob/shaspec-fusion/lesionlocator/modules/multimodal_unet.py"
click blocks "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/blob/shaspec-fusion/lesionlocator/modules/fusion_modules.py"
click tools "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/blob/shaspec-fusion/lesionlocator/utilities/benchmark_fusion.py"
click tests "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/tree/shaspec-fusion/tests"
click missing "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/blob/shaspec-fusion/lesionlocator/utilities/modality_grouping.py"
click shaspec "https://github.com/matthieuasvazadourian-dev/multimodal-extension-of-lesionlocator/blob/shaspec-fusion/lesionlocator/modules/fusion_modules.py"
...
class fusion,net,tracknet,blocks,shaspec tModel
