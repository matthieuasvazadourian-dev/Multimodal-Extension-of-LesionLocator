...
This repository builds upon and adapts the code from:
 ...
 [LesionLocator](https://github.com/MIC-DKFZ/LesionLocator) (Rokuss et al., CVPR 2025), the original code, and [PET-CT Adaptation](https://gitlab.datascience.ch/xiaoran/lesionlocator) (X. Chen, SDSC), its adaption for PET and CT imaging in the context of the LETITIA project.
