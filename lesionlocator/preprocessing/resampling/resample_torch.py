...
from lesionlocator.configuration import ANISO_THRESHOLD
from lesionlocator.imageio.simpleitk_reader_writer import SimpleITKIO
from lesionlocator.preprocessing.resampling.default_resampling import determine_do_sep_z_and_axis
...
if __name__ == '__main__':
    ...
    img_file = '/media/isensee/raw_data/LesionLocator_raw/Dataset027_ACDC/imagesTr/patient041_frame01_0000.nii.gz'
    seg_file = '/media/isensee/raw_data/LesionLocator_raw/Dataset027_ACDC/labelsTr/patient041_frame01.nii.gz'
    io = SimpleITKIO()
