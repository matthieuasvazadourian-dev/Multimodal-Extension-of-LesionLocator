...
CKPT_OUT=/home/masva/ckpt/TrainSeg900_Intermediate_Combined
OUTPUT=/home/masva/ckpt/TrainSeg900_Intermediate_Combined/fold_$FOLD
...
LesionLocator_train_segment \
  ...
  -device cuda \
  --cache \
  2>&1 | tee "$OUTPUT/train_seg_petct_combined_fold_$FOLD.txt"
