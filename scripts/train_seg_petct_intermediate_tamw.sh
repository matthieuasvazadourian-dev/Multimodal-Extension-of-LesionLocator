...
CKPT_OUT=/home/masva/ckpt/TrainSeg900_Intermediate_TAMW
OUTPUT=/home/masva/ckpt/TrainSeg900_Intermediate_TAMW/fold_$FOLD
...
LesionLocator_train_segment \
  ...
  -device cuda \
  --cache \
  2>&1 | tee "$OUTPUT/train_seg_petct_tamw_fold_$FOLD.txt"
