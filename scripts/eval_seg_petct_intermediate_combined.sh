...
CKPT=/home/masva/ckpt/TrainSeg900_Intermediate_Combined
OUTPUT=/home/masva/vis_pet_seg_eval_combined/fold_$FOLD
...
LesionLocator_track \
  ...
  2>&1 | tee "$OUTPUT/eval_seg_petct_combined_fold_$FOLD.txt"
