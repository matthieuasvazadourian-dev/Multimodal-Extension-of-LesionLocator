...
CKPT=/home/masva/ckpt/TrainSeg900_Intermediate_Weighted
OUTPUT=/home/masva/vis_pet_seg_eval_weighted/fold_$FOLD
...
LesionLocator_track \
  ...
  2>&1 | tee "$OUTPUT/eval_seg_petct_weighted_fold_$FOLD.txt"
