...
CKPT_OUT=/home/masva/ckpt/TrainSeg900_Intermediate_Weighted
OUTPUT=/home/masva/ckpt/TrainSeg900_Intermediate_Weighted/fold_$FOLD
...
LesionLocator_train_segment \
  ...
  -device cuda \
  --cache \
  2>&1 | tee "$OUTPUT/train_seg_petct_weighted_fold_$FOLD.txt"
