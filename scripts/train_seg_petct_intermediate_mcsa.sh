...
CKPT_OUT=/home/masva/ckpt/TrainSeg900_Intermediate_MCSA
OUTPUT=/home/masva/ckpt/TrainSeg900_Intermediate_MCSA/fold_$FOLD
...
LesionLocator_train_segment \
  ...
  -device cuda \
  --cache \
  2>&1 | tee "$OUTPUT/train_seg_petct_mcsa_fold_$FOLD.txt"
